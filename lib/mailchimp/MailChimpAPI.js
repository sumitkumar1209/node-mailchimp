var MailChimpAPI_v3_0 = require('./MailChimpAPI_v3_0'),
    MailChimpAPI_v2_0 = require('./MailChimpAPI_v2_0'),
...
function MailChimpAPI(apiKey, options) {
  ...
  else if (options.version == '3.0') {
    options.key = apiKey;
    return new MailChimpAPI_v3_0(options);
  }
